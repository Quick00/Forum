...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('api/showtopic').then(function (response) {
      _this.topics = response.data;
    });
  },
  methods: {
    addthread: function addthread() {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/threads', {
        name: this.name,
    ...
    deleteuser: function deleteuser(user) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete('./api/user/' + user.id);
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('api/user').then(function (response) {
    ...
    deletetopic: function deletetopic(topic) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete('./api/topic/' + topic.id);
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete('./api/deletecomment/' + topic.id);
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('api/showtopic').then(function (response) {
        _this3.topics = response.data;
      });
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.loading = true;
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('api/threads').then(function (response) {
  ...
  methods: {
    gotothread: function gotothread(thread) {
      var _this2 = this;

      this.save = thread.id;
      this.loading = true;
      var id = thread.id;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/topics', {
        id: id
        ...
        if (_this2.clicked == 2 && _this2.isLoggedIn == true) {
          _this2.canadd = true;
        }
      });
    },
    gototopic: function gototopic(topic) {
      var _this3 = this;

      this.loading = true;
      var id = topic.id;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/topic', {
        id: id
      }).then(function (response) {
        _this3.disscusions = response.data;
        _this3.clicked = 3;

        if (_this3.clicked > 1 && _this3.isLoggedIn == true) {
          _this3.canadd = true;
        }
      });
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/getcomment', {
        id: id
      }).then(function (response) {
    ...
    getuser: function getuser() {
      ...
      var user_ID = this.comments.user_ID;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/getuser', {
        user_ID: user_ID
      }).then(function (response) {
    ...
    submittopic: function submittopic() {
      ...
      var thread_ID = this.save;
      var id = this.save;
      var user_ID = this.user;
      var info = this.descriptiontopic;
      var name = this.nametopic;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/maketopic', {
        thread_ID: thread_ID,
        user_ID: user_ID,
        name: name,
        info: info
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/topics', {
        ...
        if (_this5.clicked == 2 && _this5.isLoggedIn == true) {
          _this5.canadd = true;
        }
      });
    },
    placecomment: function placecomment(disscusion) {
      var _this6 = this;

      var topics_ID = disscusion.id;
      var id = disscusion.id;
      var comment = this.comment;
      var user_ID = this.user;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/comment', {
        topics_ID: topics_ID,
        comment: comment,
        user_ID: user_ID
      }).then(function (response) {
    ...
    backfromadd: function backfromadd() {
      this.addtopic = false;
    },
    back: function back() {
    ...
    makenewtopic: function makenewtopic() {
      this.addtopic = true;
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setDefaults: function setDefaults() {
      if (this.isLoggedIn) {
        var user = JSON.parse(localStorage.getItem('Forum.user'));
        this.name = user.name;
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true& ***!
  \********************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "threadaddcontainer" }, [
      _c("h3", [_vm._v("Maak een thread")]),
      _vm._v(" "),
      _c(
        "form",
        {
        ...
        [
          ...
          _c("input", {
            ...
            attrs: { type: "text", placeholder: "Desciption", required: "" },
    ...
    _c(
      "div",
      { staticClass: "threadaddcontainer" },
      [
        _c("h3", [_vm._v("Users")]),
        _vm._v(" "),
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "homecontainer" }, [
    _c("div", { staticClass: "titlethread" }, [_vm._v("Home")]),
    _vm._v(" "),
    _vm.loading ? _c("div", { staticClass: "loading" }) : _vm._e(),
    _vm._v(" "),
    _vm.addtopic
      ? _c("div", { staticClass: "addtopic" }, [
          _c("h3", [_vm._v("Maak hier een topic aan")]),
          _vm._v(" "),
          _c("img", {
            attrs: { src: "./img/" + "backward.png" },
            on: { click: _vm.backfromadd }
          }),
          _vm._v(" "),
          _c(
            "form",
                ...
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: _vm.nametopic,
                    expression: "nametopic"
                  }
                ],
                attrs: {
                  type: "text",
                  placeholder: "Het onderwerp van uw Topic"
                },
                domProps: { value: _vm.nametopic },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.nametopic = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.descriptiontopic,
                    expression: "descriptiontopic"
                  }
                ],
                staticClass: "description",
                attrs: { placeholder: "Vul hier uw vraag over het topic in" },
                domProps: { value: _vm.descriptiontopic },
                on: {
                  keyup: function($event) {
                    ...
                    return _vm.submittopic($event)
                  },
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.descriptiontopic = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
    ...
    _vm._v(" "),
    !_vm.loading
      ? _c("div", { staticClass: "threadcontainer" }, [
          _vm.clicked > 1
            ? _c("img", {
                staticClass: "back",
                attrs: { src: "./img/" + "backward.png" },
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.clicked == 2 && _vm.isLoggedIn
            ? _c("img", {
                staticClass: "plus",
                attrs: { src: "./img/" + "plus.png" },
                on: {
                  click: function($event) {
                    return _vm.makenewtopic()
                  }
                }
              })
            : _vm._e(),
                ...
                return _vm.clicked == 1
                  ? _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.gotothread(thread)
                          }
                        }
                      },
                      [
                        _c("div", { staticClass: "threadname" }, [
                          _vm._v(_vm._s(thread.name))
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "threaddescription" }, [
                          _vm._v(_vm._s(thread.description))
                        ])
                      ]
                    )
                  : _vm._e()
                ...
                return _vm.clicked == 2
                  ? _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.gototopic(topic)
                          }
                        }
                      },
                      [_c("div", [_vm._v(_vm._s(topic.name))])]
                    )
                  : _vm._e()
              }),
              _vm._v(" "),
              _vm._l(_vm.disscusions, function(disscusion) {
                return _vm.clicked == 3
                  ? _c("li", { key: disscusion.id }, [
                      _c("div", { staticClass: "topictitle" }, [
                        _vm._v(_vm._s(disscusion.name))
                      ]),
                      _vm._v(" "),
                      _c(
                        "div",
                        ...
                        [
                          _c("div", { staticClass: "inhoud" }, [
                            _vm._v(_vm._s(disscusion.info))
                          ]),
                          _vm._v(" "),
                          _c("br"),
                          _vm._v(" "),
                          _c("input", {
                            ...
                            on: {
                              keyup: function($event) {
                                ...
                                return _vm.placecomment(disscusion)
                              },
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/register.vue?vue&type=template&id=aacc3324&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/register.vue?vue&type=template&id=aacc3324&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  render: function render(h) {
    return h(_components_main_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./admin.vue?vue&type=template&id=5c321c94&scoped=true& */ "./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "5c321c94",
  null
...
/***/ "./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true& ***!
  \**************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./admin.vue?vue&type=template&id=5c321c94&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/admin.vue?vue&type=template&id=5c321c94&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_admin_vue_vue_type_template_id_5c321c94_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _main_vue_vue_type_template_id_c176d7f8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.vue?vue&type=template&id=c176d7f8&scoped=true& */ "./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _main_vue_vue_type_template_id_c176d7f8_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _main_vue_vue_type_template_id_c176d7f8_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "c176d7f8",
  null
...
/***/ "./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true& ***!
  \*************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_template_id_c176d7f8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./main.vue?vue&type=template&id=c176d7f8&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/main.vue?vue&type=template&id=c176d7f8&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_template_id_c176d7f8_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_register_vue_vue_type_template_id_aacc3324_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./register.vue?vue&type=template&id=aacc3324&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/register.vue?vue&type=template&id=aacc3324&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_register_vue_vue_type_template_id_aacc3324_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_register_vue_vue_type_template_id_aacc3324_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _js_components_login__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/js/components/login */ "./resources/js/components/login.vue");
...
/* harmony import */ var _js_components_admin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/js/components/admin */ "./resources/js/components/admin.vue");
/* harmony import */ var _js_components_logout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/js/components/logout */ "./resources/js/components/logout.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    path: '/',
    name: _js_components_home__WEBPACK_IMPORTED_MODULE_2__["default"],
    component: _js_components_home__WEBPACK_IMPORTED_MODULE_2__["default"]
  }, {
    path: '/login',
    name: _js_components_login__WEBPACK_IMPORTED_MODULE_3__["default"],
    component: _js_components_login__WEBPACK_IMPORTED_MODULE_3__["default"]
  }, {
    path: '/register',
    name: _js_components_register__WEBPACK_IMPORTED_MODULE_4__["default"],
    component: _js_components_register__WEBPACK_IMPORTED_MODULE_4__["default"]
  }, {
    path: '/admin',
    name: _js_components_admin__WEBPACK_IMPORTED_MODULE_5__["default"],
    component: _js_components_admin__WEBPACK_IMPORTED_MODULE_5__["default"],
    meta: {
      requiresAuth: true,
      is_admin: true
    }
    ...
    path: '/logout',
    name: _js_components_logout__WEBPACK_IMPORTED_MODULE_6__["default"],
    component: _js_components_logout__WEBPACK_IMPORTED_MODULE_6__["default"],
    meta: {
      requiresAuth: true
    }
  }]
...
__webpack_require__(/*! C:\xampp\htdocs\ForumLaravel\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ForumLaravel\resources\sass\app.scss */"./resources/sass/app.scss");
